<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Reservation.aspx.cs" Inherits="BTS.Reservation" %>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" class="auto-style3" style="text-align: center">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server" Height="27px" Width="150px" OnSelectedIndexChanged="Source_SelectedIndexChanged" AutoPostBack="True">
                                                                  <asp:ListItem Text="--select--" Value="--select--"></asp:ListItem>
                                                                <asp:ListItem Text="KL(PUDURAYA)" Value="KL(PUDURAYA)"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" class="auto-style3" style="text-align: center">
                                                                <ContentTemplate>
                                                                    <div id="txtHint">
                                                                        <asp:DropDownList CssClass="form" ID="Destination" runat="server" Height="27px" Width="150px" OnSelectedIndexChanged="Destination_SelectedIndexChanged" AutoPostBack="True" Enabled="False">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" class="auto-style3" style="text-align: center">
                                                                ...
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="departon" runat="server" Height="27px" Width="150px" OnSelectedIndexChanged="departon_SelectedIndexChanged" AutoPostBack="True" Enabled="False">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" class="auto-style3" style="text-align: center">
                                                                ...
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="DepartureTime" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DepartureTime_SelectedIndexChanged" Height="27px" Width="150px" Enabled="False">
                                                                         <asp:ListItem Text="--select--" Value="--select--"></asp:ListItem>
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" style="width: 432px">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><asp:RequiredFieldValidator ID="rfvname" runat="server" ErrorMessage="*" ControlToValidate="txtname" ForeColor="Red" /></td>
                                                            </tr>
                                                             <tr>
                                                                <td class="auto-style14">
                                                                   IC No. / Passport No.
                                                                ...
                                                                <td><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtname" ForeColor="Red" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="auto-style14">
                                                                    Phone Number
