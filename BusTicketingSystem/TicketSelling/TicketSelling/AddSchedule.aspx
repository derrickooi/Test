<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSchedule.aspx.cs" Inherits="TicketSelling.AddSchedule" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" CssClass="modalPopup" runat="server" Height="284px" Width="359px">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="RouteId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Route]"></asp:SqlDataSource>
            <br />
        ...
        <p>
            ...
            <asp:MaskedEditExtender ID="MaskedEditExtender1" TargetControlID="txtTime" MaskType="None" Mask="9:99LL" runat="server"></asp:MaskedEditExtender>
