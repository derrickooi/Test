<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchSchedule.aspx.cs" Inherits="TicketSelling.SearchSchedule" %>
...
<body>
    ...
    <table style="width: 38%; margin-right: 0px;">
        ...
        <asp:Button runat="server" OnClick="Unnamed1_Click" ValidationGroup="2" Text="Update" ID="UpdateBtn" />
