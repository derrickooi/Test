...
{
    /// <summary>
    /// Summary description for WebPayment
    /// </summary>
    ...
    public class WebPayment : System.Web.Services.WebService
    {
        ...
        {
            using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["BTSDBConn"].ConnectionString))
            {
