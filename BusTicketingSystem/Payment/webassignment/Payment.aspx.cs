...
namespace PaymentModule
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        {
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["Payment"].ConnectionString);
            conn.Open();
        ...
        protected void PayPalBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            double itemAmount = double.Parse(txtGTotal.Text);
            string currencyCode = "USD";
            string returns = "http://localhost:55003/PaymentSummary.aspx";
