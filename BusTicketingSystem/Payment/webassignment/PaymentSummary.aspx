<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentSummary.aspx.cs" Inherits="PaymentModule.PaymentSummary" %>
...
Kamunting Industrial Estate,
        ...
        &nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Text="Exit" OnClientClick="close_window()" Height="32px" Width="85px"/>
        </p>
    </form>
</body>
</html>